...
Para acessar o servidor enquanto o mesmo está em execução, basta acessar a porta 80 do localhost utilizando o navegador. Para acessar as demais páginas, utilize as url's parciais descritas no tópico acima junto com a url base do servidor (localhost). Ex: ```python
http://localhost/nosql
``` (porta 80 por padrão e por isso não é necessário escrita de localhost:80/nosql)
